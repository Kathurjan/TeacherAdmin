...
public class Classroom3 implements Initializable {
    @FXML
    ...
    @FXML
    private TableView<Student> Class3TableView;
    ...
    private void populateTableview (){
        ...
        System.out.println(studentlogic.getStudent2());
        Class3TableView.setItems(studentlogic.getStudent2());

    }
    @FXML
    private void displaySelected(MouseEvent mouseEvent) throws NullPointerException {
        Student student = Class3TableView.getSelectionModel().getSelectedItem();
